  ...
  return (
    <div className="pages">
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Zico Games, the
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Easy Achieve, Balassore, Odisha, India..
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Zico Games, accessible
            from{" "}
            <a
      ...
      <ul>
        <li>By email: easyachieve@gmail.com</li>
      </ul>
    </div>
  );
};
