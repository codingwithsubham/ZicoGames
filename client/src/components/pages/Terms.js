...
const Terms = () => {
  return (
    <div className="pages">
      ...
      <p>Welcome to ZIco Games!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Easy Achieve's Website, located at https://zicogames.onrender.com/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use ZIco Games if you do not
      ...
      <p>
        We employ the use of cookies. By accessing ZIco Games, you
        agreed to use cookies in agreement with the Easy Achieve's Privacy
        Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Easy Achieve and/or its licensors own the
        intellectual property rights for all material on ZIco Games.
        All intellectual property rights are reserved. You may access this from
        ZIco Games for your own personal use subjected to restrictions
        set in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from ZIco Games</li>
        <li>Sell, rent or sub-license material from ZIco Games</li>
        <li>Reproduce, duplicate or copy material from ZIco Games</li>
        <li>Redistribute content from ZIco Games</li>
      </ul>
      ...
      <p>
        ...
        Achieve does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Easy Achieve,its agents and/or affiliates. Comments reflect the views
        and opinions of the person who post their views and opinions. To the
        extent permitted by applicable laws, Easy Achieve shall not be liable
      ...
      <p>
        Easy Achieve reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant Easy Achieve a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Easy Achieve; and (d) the link
      ...
      <p>
        ...
        e-mail to Easy Achieve. Please include your name, your organization
      ...
      <p>
        No use of Easy Achieve's logo or other artwork will be allowed for
